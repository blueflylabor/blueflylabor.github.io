...
\end{align}
$$
![img](https://raw.githubusercontent.com/blueflylabor/images/main/%7BK27TS8@YE9O01$$JFWZL%7BGI.jpg)
$$
\begin{align}
&(3)一个数列有没有极限与前有限项无关\\
\end{align}
...
##### 1) The limit of a function as the independent variable approaches infinity
...
\end{align}
$$
##### 2) When the independent variable approaches a finite value, the limit of the function
