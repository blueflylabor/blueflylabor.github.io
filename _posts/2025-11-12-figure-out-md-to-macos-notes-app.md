---
layout: post
title: "don’t want to update the macOS to figure out the Markdown import to Mac Note app"
categories:
  - MacOS
  - OSbug
  - tools
...
## **don’t want to update the macOS to figure out the Markdown import to Mac Note app**
